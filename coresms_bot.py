...
BOT_USERNAME     = "@Noxvoidbot"             # ← update (without @)
...
PANEL_B_TOKEN = "fzLDmdiz7w2WJUMJWFGMyE6Ks35s0b2etKq4CdQHqs"

# ── Panel C (Core SMS — session login + HTML scrape)
CORE_SMS_URL      = "http://139.99.68.231/ints"
CORE_SMS_USERNAME = "Coolvicky"   # ← your username
CORE_SMS_PASSWORD = "Coolvicky"            # ← paste your password here
